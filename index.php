...
<?php //die();
/* 
database khusus tim roket

saghahos_timrocketsmakassar (nama database dan username)
password: timrocketsmakassar

FTP indodigitalpi.com
user: timrocketsmakassarcom
pass: t1mr0cketsMakassar

FTP indodigitalpi.space
user: timrocketsmakassarspace
pass: t1mr0cketsMakassar
*/

/*
Login 2024foreverptindodigitalpi pass email

Login akun microsoft PT Indo Digital Pi

jayarayainnovation24@gmail.com
@ptindodigitalpiMD2024

echo date_default_timezone_get()." ".date("Y-m-d",strtotime(date("Y-m-".(date("d")-1))))." - "."<br/>";
echo date("Y-m-d H:i:s")." - ".date("Y-m-d H:i:s",(strtotime(date("Y-m-d H:i:s"))+900));
die();
*/
...
//echo @mengacakstring("2024foreverptindodigitalpi",5); die();
